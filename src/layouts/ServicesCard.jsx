const ServicesCard = ({ icon, title, text, secondTitle, onClick }) => {
  return (
    <div
      onClick={onClick}
      className="select-none group flex flex-col mt-6 lg:mt-10 items-center text-center gap-2 w-full lg:w-1/3 p-5 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] rounded-lg cursor-pointer lg:hover:-translate-y-6 lg:transition duration-300 lg:ease-in-out"
    >
